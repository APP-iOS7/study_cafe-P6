              ...
              child: SizedBox(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      //집중존
                      Positioned(top: 10, left: 10, child: _seatWidget(true)),
                      Positioned(top: 10, left: 70, child: _seatWidget(true)),
                      Positioned(top: 70, left: 10, child: _seatWidget(false)),
                      Positioned(top: 70, left: 70, child: _seatWidget(false)),
                      Positioned(top: 10, left: 130, child: _seatWidget(true)),
                      Positioned(top: 70, left: 130, child: _seatWidget(false)),
                      Positioned(top: 130, left: 10, child: _seatWidget(true)),
                      Positioned(top: 130, left: 70, child: _seatWidget(false)),
                      Positioned(
                        top: 130,
                        left: 130,
                        child: _seatWidget(false),
                      ),
                      Positioned(top: 190, left: 10, child: _seatWidget(false)),
                      Positioned(top: 190, left: 70, child: _seatWidget(false)),
                      Positioned(
                        top: 190,
                        left: 130,
                        child: _seatWidget(false),
